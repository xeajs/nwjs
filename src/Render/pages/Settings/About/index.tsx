    ...
    <div>
      <Form labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
        <Form.Item label="版本信息">
          ...
          <Button type="dashed" size="small" style={{ marginRight: '16px' }} onClick={() => {}}>
            检查更新
          </Button>
          <Button
            type="dashed"
        ...
        <Form.Item label="其他资源">
          <Button
            ...
            style={{ marginRight: '16px' }}
            onClick={() => {
              // shell.openExternal('https://gitee.com/xieyejiang/nwjs');
            }}
          >
            Gitee 仓库
          </Button>
          <Button
            ...
            style={{ marginRight: '16px' }}
            onClick={() => {
              // shell.openExternal('https://github.com/xeajs/nwjs');
            }}
          >
            Github 仓库
          </Button>
